...
connection.commit()
commit = "CREATE TABLE IF NOT EXISTS GREA1 (No int, A VARCHAR(50), B VARCHAR(50), C VARCHAR(50), D VARCHAR(50), E VARCHAR(50), F VARCHAR(50), Answer1 VARCHAR(50), Answer2 VARCHAR(50));"
cursor.execute(commit)
connection.commit()
ba = 0
No = 134
            ...
            if len(Right) == 15:
                ...
                if len(question) == 2:
                    ...
                    with connection.cursor() as cursor:
                        ...
                        sql += "(No, A, B, C, D, E, Answer1, Answer2) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"
                        cursor.execute(sql, (No1, A, B, C, D, E, Right1, Right2))
                    connection.commit()
            time.sleep(0.05)
connection.close()